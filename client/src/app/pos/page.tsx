  ...
  return (
    <div className="flex h-screen flex-col bg-[#fdfbf7] text-stone-800 font-body select-none">
      ...
      {loading ? (
        ...
        <div className="flex flex-1 overflow-hidden pb-14 md:pb-0 relative">
          
          {/* COLUMN 1: TABLES GRID (LEFT - 25% width) */}
          <section className={`w-full md:w-1/4 flex-col border-r border-stone-200 bg-stone-50/50 p-4 ${activeMobileTab === "tables" ? "flex" : "hidden md:flex"}`}>
          ...
          <section className={`w-full md:w-[45%] flex-col border-r border-stone-200 p-4 ${activeMobileTab === "menu" ? "flex" : "hidden md:flex"}`}>
          ...
          <section className={`w-full md:w-[30%] flex-col bg-stone-50/50 border-l border-stone-200 p-4 ${activeMobileTab === "bill" ? "flex" : "hidden md:flex"}`}>
            {selectedTable ? (
              ...
              <div className="flex flex-1 flex-col items-center justify-center text-center text-stone-400 p-4">
                ...
                <button
                  ...
                  className="md:hidden flex items-center gap-1.5 rounded-lg bg-[#3e2723] px-4 py-2 text-xs font-semibold text-white shadow-md active:scale-95 transition"
                >
          ...
          <div className="md:hidden absolute bottom-0 left-0 right-0 h-14 bg-white border-t border-stone-200 flex items-center justify-around px-2 z-20 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
            <button
              onClick={() => setActiveMobileTab("tables")}
